...
<div class="row">
	...
	<table  style="min-width: 600px;" >
        <tr align="left">
            <td><b>GPA</b>   : 
                <?php
                    if($banGp==0 || $engGp==0 ||$ictGp==0 || $workGp==0 || $ecoGp==0 || $civGp==0
                         ){
                            $GPA=0.00;
                        ...
                        $Gpa=($banGp +$engGp +$ictGp +$workGp +$ecoGp+$civGp +$optional)/6;
                        $GPA = sprintf ("%.2f", $Gpa);
                        echo $GPA;}
            ...
            <td align="center"><b>Total Number</b>  : {{$total_number=$banTotal+ $engTotal+ $ictTotal+ $civicsTotal+ $sworkTotal+ $ecoTotal+ $agriTotal}}</td> 
        </tr>
        ...
        <tr><td colspan="2">
           <b> GPA</b> <span style="font-size: 12px;">(Without 4th sub)</span> : <?php
             if($banGp==0 || $engGp==0 ||$ictGp==0 || $workGp==0 || $ecoGp==0 || $civGp==0)
                    ...
                    $Gpa=($banGp +$engGp +$ictGp +$workGp +$ecoGp +$civGp)/6;
