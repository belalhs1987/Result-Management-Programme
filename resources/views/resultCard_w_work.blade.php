		...
		<tr align="left">
			<td><b>GPA</b>   : 
				<?php
                        ...
                        if($banGp==0 || $engGp==0 ||$ictGp==0 || $civGp==0 || $ecoGp==0 || $hisGp==0
                         ){
                            $GPA=0.00;
			...
			<td colspan="2" align="center"><b>Total Number</b>  : {{$total_number=$banTotal+ $engTotal+ $ictTotal+ $historyTotal+ $civicsTotal+ $ecoTotal+ $agriTotal}}</td> 
		</tr>
        <tr><td colspan="2">
