...
<div class="row">
	<div class="col-md-12" align="center">
	 <table  style="min-width: 220px;" align="center">
		<tr>
	...
	<table  style="min-width: 600px;" >
		<tr align="left">
			<td colspan="2"><b>GPA</b>   : 
                ...
                if($optional_sub == 109) {
                    if($banGp==0 || $engGp==0 ||$ictGp==0 || $workGp==0 || $hisGp==0 || $civGp==0)
                      {
                        $GPA=0;
                    echo "<span style='color:red;'>$GPA (F)</spanspan>";
                     }
                    else{
                            if($ecoGp>2){
                        $optional=$ecoGp-2;
                ...
                elseif($optional_sub ==269) {
                     if($banGp==0 || $engGp==0 ||$ictGp==0 || $workGp==0 || $hisGp==0 || $ecoGp==0)
                      {
                        $GPA=0;
                    ...
                    $Gpa=($banGp +$engGp +$ictGp +$workGp +$ecoGp +$hisGp+$optional)/6;
                    $GPA = sprintf ("%.2f", $Gpa);
                    echo $GPA;}
                }
                elseif($optional_sub ==271) {
                    ...
                    $Gpa=($banGp +$engGp +$ictGp +$civGp +$ecoGp +$hisGp+$optional)/6;
                    $GPA = sprintf ("%.2f", $Gpa);
                    echo $GPA;}
                }
                 elseif($optional_sub == 267){
                    if($banGp==0 || $engGp==0 ||$ictGp==0 || $workGp==0 || $civGp==0|| $ecoGp==0)
                        {
                            $GPA=0;
                    echo "<span style='color:red;'>$GPA (F)</span>";}
                    else{
                    ...
                    $Gpa=($banGp +$engGp +$ictGp +$workGp +$civGp +$ecoGp+$optional)/6;
                    $GPA = sprintf ("%.2f", $Gpa);
                    echo $GPA;}
                    }
                    
				else{echo $optional_sub;}
				                 ?>
			  </td>
			<td colspan="2"><b>Total Number</b>  :   {{$total_number=$banTotal+$engTotal+$ictTotal+$sworkTotal+$historyTotal+$civicsTotal+$ecoTotal}}</td> 
		</tr>
        <tr>
            <td colspan="2" align="left">
                <b> GPA</b> <span style="font-size: 12px;">(Without 4th sub)</span> :
                    <?php
                ...
                if($optional_sub == 109) {
                    if($banGp==0 || $engGp==0 ||$ictGp==0 || $workGp==0 || $hisGp==0 || $civGp==0)
                      {
                        $GPA_W_OP=0;
                    echo "<span style='color:red;'>$GPA_W_OP (F)</spanspan>";
                     }
                    else{
                ...
                elseif($optional_sub ==269) {
                    ...
                    $Gpa=($banGp +$engGp +$ictGp +$workGp +$ecoGp +$hisGp)/6;
                    $GPA_W_OP = sprintf ("%.2f", $Gpa);
                    echo $GPA_W_OP;}
                }
                elseif($optional_sub ==271) {
                    ...
                    $Gpa=($banGp +$engGp +$ictGp +$civGp +$ecoGp +$hisGp)/6;
                    $GPA_W_OP = sprintf ("%.2f", $Gpa);
                    echo $GPA_W_OP;}
                }
                 elseif($optional_sub == 267){
                    ...
                    $Gpa=($banGp +$engGp +$ictGp +$workGp +$civGp +$ecoGp)/6;
                    $GPA_W_OP = sprintf ("%.2f", $Gpa);
                    echo $GPA_W_OP;}
                    }
