...
<div class="row">
	...
	<table  style="min-width: 600px;" >
        <tr align="left">
            <td><b>GPA</b>   : 
                <?php
                    if($banGp==0 || $engGp==0 ||$ictGp==0 || $workGp==0 || $ecoGp==0 || $hisGp==0
                         ){
                            $GPA=0.00;
            ...
            <td align="center"><b>Total Number</b>  : {{$total_number=$banTotal+ $engTotal+ $ictTotal+ $historyTotal+ $sworkTotal+ $ecoTotal+ $agriTotal}}</td> 
        </tr>
