...
<div class="container" style=" min-height: 500px;">
	<div class="wrap-login100  p-t-30 p-b-50 text-center m-4">
		 ...
		 <form action="{{ url('ScInsertMarks')}}" method="post" enctype="multipart/form-data">
		 	{{ csrf_field()}}
                        ...
                        <div class="form-group col-md-4">
                                                ...
                                                <input class="form-control" name="chem_mcq"   pattern="[0-9]{0,10}">
                                             </div>
                                               <div class="form-group col-md-4">
                                                <label>Chemistry CQ </label>
                                                <input class="form-control" name="chem_cq"   pattern="[0-9]{0,10}">
                                              </div> 
                                              <div class="form-group col-md-4">
                                                <label>Chemistry Prac.</label>
                                                <input class="form-control" name="chem_prac"   pattern="[0-9]{0,10}">
                                            </div> 
  
											  <div class="form-group col-md-4">
                                                <label>Physics MCQ  </label>
                                                <input class="form-control" name="phy_mcq"   pattern="[0-9]{0,10}">
                                              </div> 
                                              <div class="form-group col-md-4">
                                                <label>Physics CQ  </label>
                                                <input class="form-control" name="phy_cq"   pattern="[0-9]{0,10}">
                                              </div>
                                              <div class="form-group col-md-4">
                                                <label>Physics Prac.</label>
                                                <input class="form-control" name="phy_prac"   pattern="[0-9]{0,10}">
                                            </div> 
											  ...
											  <div class="form-group col-md-4">
                                                ...
                                                <input class="form-control" name="bio_mcq"   pattern="[0-9]{0,10}">
                                              </div> 
                                              <div class="form-group col-md-4">
                                                <label>Biology CQ  </label>
                                                <input class="form-control" name="bio_cq"   pattern="[0-9]{0,10}">
                                              </div> 
                                              <div class="form-group col-md-4">
                                                <label>Biology Prac.</label>
                                                <input class="form-control" name="bio_prac"   pattern="[0-9]{0,10}">
                                            </div> 
                          <div class="form-group col-md-4">
                                                <label>Math MCQ </label>
                                                <input class="form-control" name="math_mcq"   pattern="[0-9]{0,10}">
                                              </div> 
                                              <div class="form-group col-md-4">
                                                <label>Math CQ  </label>
                                                <input class="form-control" name="math_cq"   pattern="[0-9]{0,10}">
                                              </div> 
                                              <div class="form-group col-md-4">
                                                <label>Math Prac.</label>
                                                <input class="form-control" name="math_prac"   pattern="[0-9]{0,10}">
                                            </div> 
