	 ...
	 <div class="container" style="">
		<div class="main_body">
			...
			<div class="mainMenu">
                 ...
                 <div class="col-md-4">
                <a href="{{ url('scFullResultdownload')}}" target="_blank" class="btn btn-success">Download Result</a>
                </div> <br>
                        ...
                        <tbody>
                            ...
                            <tr align="center">
                               ...
                               <td>{{$chemTotal = $chem_mcq+$chem_cq}}</td>
                                ...
                                <td>{{$optional_sub=$sc_results->optional_sub}} </td>
                                <td> 
                                  <?php
                                ...
                                <td> </td>
                                 <td> <a href="{{ url('scEditResult/'.$sc_results->roll)}}" class="btn btn-primary"> Edit</a></td>
                                <td><a href="{{ url('scResultCardDownload/'.$sc_results->roll)}}" class="btn btn-success" >Download</a></td>
                                <td><a href="{{ url('scDeleteResult/'.$sc_results->roll)}}" class="btn btn-danger">Delete</a></td>
