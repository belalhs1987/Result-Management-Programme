	 ...
	 <div class="container">
		<div class="main_body">
			...
			<div class="mainMenu">
             ...
             <div class="col-md-4">
                <a href="{{ url('bsFullResultdownload')}}" target="_blank" class="btn btn-success">Download Result</a>
                </div>
			...
			<div class="result">
				<div class="row">
                    ...
                    <div class="col-md-4" align="right" style="padding-right: 50px; font-size: 8px;">
                        <table border="1px" style="min-width: 100px; text-align: center;">
                            <tr>
                                <td colspan="3"><b>Grading System</b></td>
                            </tr>
                            <tr><th>Marks</th><th>L.G</th><th>G.P</th></tr>
                             <tr><td>80-100</td><td>A+</td><td>5</td></tr>
                             <tr><td>70-79</td><td>A</td><td>4</td></tr>
                             <tr><td>60-69</td><td>A-</td><td>3.6</td></tr>
                            ...
                            <tr align="center">
                               ...
                               <td>{{$accTotal = $acc_mcq+$acc_cq}}</td>
                                ...
                                <td>@if( $b_org_Total>0 && $b_org_Total<=32)
                                        <h6 style='color:red;'>{{ $b_org_Gp=0.00 }}</h6>
                                ...
                                <td>@if( $eco_Total>0 && $eco_Total<=32)
                                        <h6 style='color:red;'>{{ $b_otg_Gp=0.00 }}</h6>
                                ...
                                <td> 
                                    ...
                                    {{"A-"}}
                                    @elseif($GPA>=3.00 && $GPA<=3.49)    
                                        {{"B"}}
                                    @elseif($GPA>=2.00 && $GPA<=2.99)
                                    {{"C"}}
                                    @elseif($GPA>=1.00 && $GPA<=1.99)
                                    {{"D"}}
                                    @else
                                    <p style='color:red;'> {{"F"}}</p>
                                    @endif
                                </td>
                                 <td> <a href="{{ url('bsEditResult/'.$bs_results->roll)}}" class="btn btn-primary"> Edit</a></td>
                                <td><a href="{{ url('bsResultCardDownload/'.$bs_results->roll)}}" class="btn btn-success" >Download</a></td>
                                <td><a href="{{ url('bsDeleteResult/'.$bs_results->roll)}}" class="btn btn-danger">Delete</a></td>
